...
public class Program_Webview extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_program__webview);
    ...
    private void init() {
        ...
        webView.setBackgroundResource(R.drawable.program_background);
        progressDialog = new ProgressDialog(Program_Webview.this);
    ...
    public boolean onOptionsItemSelected (MenuItem item){
        ...
        if (id == R.id.action_home) {
            Intent intent = new Intent(Program_Webview.this, MainActivity.class);
            ...
            Intent intent = new Intent(Program_Webview.this, AboutMe.class);
            startActivity(intent);
            return true;
