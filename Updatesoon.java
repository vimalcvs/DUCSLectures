...
public class Updatesoon extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_updatesoon);
    ...
    private void init() {
        ...
        progressDialog = new ProgressDialog(Updatesoon.this);
    ...
    public boolean onOptionsItemSelected (MenuItem item){
        ...
        if (id == R.id.action_home) {
            Intent intent = new Intent(Updatesoon.this, MainActivity.class);
            ...
            Intent intent = new Intent(Updatesoon.this, AboutMe.class);
            startActivity(intent);
            return true;
